...
const ourSkills = ['C', 'C++', 'C#', 'JavaScript', 'TypeScript', 'Python', 'Java', 'Go', 'HTML', 'CSS', 'React','Nuxt', 'Vue' , 'Node', 'VBA','PHP', 'Flask', 'Django', 'PostgreSQL', 'MySQL', 'Unity', 'Open CV','Open GL','Bootstrap', 'Git' ,'Docker']
